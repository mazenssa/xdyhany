...
client.on("message", message => {
 if (message.content === "1help") {
  const embed = new Discord.RichEmbed() 
      ...
      .setDescription(`
                                ? ?????????????????? ?
:musical_note: 1play | áÊÔÛíá ÇÛäíÉ
:musical_note: 1join | ÏÎæá Ñæãß ÇáÕæÊí 
:musical_note: 1disconnect | ÇáÎÑæÌ ãä Ñæãß ÇáÕæÊí 
:musical_note: 1skip | ÊÎØí ÇáÃÛäíÉ 
:musical_note: 1pause |ÇíÞÇÝ ÇáÇÛäíÉ ãÄÞÊÇ
:musical_note: 1resume | ÊßãáÉ ÇáÇÛäíÉ 
:musical_note: 1queue | ÇÙåÇÑ ÞÇÆãÉ ÇáÊÔÛíá
:musical_note: 1np | ÇÙåÇÑ ÇáÇÛäíÉ Çááí ÇäÊ ãÔÛáåÇ ÍÇáíÇ 
:musical_note: 1avatar | ÇÝÇÊÇÑ ÇáÔÎÕ ÇáãØáæÈ 
:musical_note: 1ping | ãÚÑÝÉ ping ÇáÈæÊ 
                                ? ?????????????????? ? 
`)

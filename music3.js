...
client.on("message", message => {
 if (message.content === "3help") {
  const embed = new Discord.RichEmbed() 
      ...
      .setDescription(`
                                ? ?????????????????? ?
:musical_note: 3play | áÊÔÛíá ÇÛäíÉ
:musical_note: 3join | ÏÎæá Ñæãß ÇáÕæÊí 
:musical_note: 3disconnect | ÇáÎÑæÌ ãä Ñæãß ÇáÕæÊí 
:musical_note: 3skip | ÊÎØí ÇáÃÛäíÉ 
:musical_note: 3pause |ÇíÞÇÝ ÇáÇÛäíÉ ãÄÞÊÇ
:musical_note: 3resume | ÊßãáÉ ÇáÇÛäíÉ 
:musical_note: 3queue | ÇÙåÇÑ ÞÇÆãÉ ÇáÊÔÛíá
:musical_note: 3np | ÇÙåÇÑ ÇáÇÛäíÉ Çááí ÇäÊ ãÔÛáåÇ ÍÇáíÇ 
:musical_note: 3avatar | ÇÝÇÊÇÑ ÇáÔÎÕ ÇáãØáæÈ 
:musical_note: 3ping | ãÚÑÝÉ ping ÇáÈæÊ 
                                ? ?????????????????? ? 
`)
